import m from 'src/assets/images'
export const data = {
  banner: [
    {
      to: "/link",
  ...
  products: [
    {
      ...
      img: "src/assets/images/tshirt_red_480x400.webp",
      price: 180,
      originPrice: 200,
      discountPrice: 20,
    ...
    },
    {
      ...
      link: "/product/detail",
      name: "Great product name goes here",
      img: "src/assets/images/tshirt_grey_480x400.webp",
      price: 475,
      originPrice: 0,
      discountPrice: 0,
    ...
    },
    {
      ...
      link: "/product/detail",
      name: "Great product name goes here",
      img: "src/assets/images/tshirt_black_480x400.webp",
      price: 1900,
      originPrice: 2000,
      discountPrice: 100,
      discountPercentage: 0,
    ...
    },
    {
      ...
      link: "/product/detail",
      name: "Great product name goes here",
      img: "src/assets/images/tshirt_green_480x400.webp",
      price: 10,
      originPrice: 0,
      discountPrice: 0,
      discountPercentage: 0,
